...
class Postman {
  ...
  confirmation (location) {
    const matchDate = scheduler.getNext(location)
  ...
  locationsPrompt (isNewbie) {
    ...
    const text = random([
      ...
      `I'm glad to hear from you.\nI am *Erna* and organize lunch dates every ${matchDay} at ${matchTime}.\nWhat list can I put you on?😉`
    ])

    const newbieText = random([
      `Hi newbie, nice to meet you!👋🏼\n\nMy name is *Erna* and I assist with your personal lunch date🙋🏼‍♀️.\nJust choose the location you wanna join and every ${matchDay} at ${matchTime} I'll set up a private conversation with your match right here in Slack.\nIt's really straightforward, isn't it?\n\nSome more hints:\n1) no worries, nobody sees our current conversation 🤫\n2) enter the command again to update or delete your registration `
    ])
