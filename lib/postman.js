...
class Postman {
  constructor () {
    ...
    this._confirmations = [
      { text: `Awesome 🎉\nI will notify you at ${environment.matchTime.pretty} about your match right here in Slack.` },
      { text: `You wouldn't believe whom I've found as your match!😱\nI'll tell you at ${environment.matchTime.pretty} right here in Slack.` }
    ]
