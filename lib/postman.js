...
class Postman {
  ...
  locationsPrompt (isNewbie) {
    ...
    const newbieText = random([
      `Hi Newbie, nice to meet you!👋🏼\nMy name is *Erna* and I assist with your personal lunch date🙋🏼‍♀️.\nJust choose the location you wanna join and every ${matchDay} at ${matchTime} I'll set up a private conversation with your match right here in Slack. It's really straightforward, isn't it?\nNo worries, nobody sees our current conversation 😊.`
    ])
